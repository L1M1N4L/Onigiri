  ...
  const courseLevels: CourseLevel[] = [
    {
      ...
      features: ['Hiragana & Katakana', 'Basic Grammar', 'Essential Vocabulary', 'Simple Conversations']
    },
    {
      level: 'Intermediate',
      description: 'Expand your Japanese abilities',
      features: ['Common Kanji', 'Complex Grammar', 'Business Japanese', 'Cultural Context']
    },
    {
      level: 'Advanced',
      description: 'Achieve native-like proficiency',
      features: ['Advanced Kanji', 'Nuanced Expression', 'Academic Japanese', 'Professional Writing']
    }
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="py-20 bg-white">
        <div className="px-6 mx-auto max-w-7xl">
          <h2 className="text-3xl font-bold text-center text-[#14274E]">Why Choose ONIGIRI?</h2>
          <p className="mt-4 text-xl text-center text-[#14274E]/70">Modern e-learning platform meets traditional Japanese expertise</p>
          ...
          <div className="grid gap-8 mt-12 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={feature.title} className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-[#14274E]">{feature.title}</h3>
      ...
      <section className="py-20 bg-stone-50">
        <div className="px-6 mx-auto max-w-7xl">
          <h2 className="text-3xl font-bold text-center text-[#14274E]">Structured Learning Path</h2>
          <p className="mt-4 text-xl text-center text-[#14274E]/70">Follow our carefully designed curriculum for optimal progress</p>
          
          <div className="grid gap-8 mt-12 md:grid-cols-3">
            {courseLevels.map((course) => (
              <div key={course.level} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow p-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-2xl font-bold text-[#14274E]">{course.level}</h3>
                  <Award className="w-8 h-8 text-[#14274E]" />
                </div>
                <p className="mt-2 text-[#14274E]/70">{course.description}</p>
                <div className="mt-4 space-y-2">
                  {course.features.map((feature) => (
                    <div key={feature} className="flex items-center gap-2 text-[#14274E]/70">
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="p-6">
              ...
              <p className="mt-2 text-[#14274E]/70">
                Access courses 24/7 and progress through lessons at your own speed.
              </p>
            </div>
            <div className="p-6">
            ...
            <div className="p-6">
              ...
              <p className="mt-2 text-[#14274E]/70">
                Learn with materials developed by Kouyou Institute's language experts.
              </p>
            </div>
          </div>
        </div>
  ...
  <div className="px-6 mx-auto max-w-7xl">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
      <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
        ...
        <div className="text-sm text-[#14274E]/70">Success Rate on<br />JLPT N5-N3</div>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
        <div className="text-4xl font-bold text-[#14274E] mb-2">82%</div>
        <div className="text-sm text-[#14274E]/70">Success Rate on<br />JLPT N2-N1</div>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
        <div className="text-4xl font-bold text-[#14274E] mb-2">15K+</div>
        <div className="text-sm text-[#14274E]/70">JLPT Certifications<br />Achieved</div>
      </div>
      <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
        <div className="text-4xl font-bold text-[#14274E] mb-2">50K+</div>
        <div className="text-sm text-[#14274E]/70">Active Students<br />Worldwide</div>
      </div>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div className="space-y-6">
        <h2 className="text-3xl font-bold text-[#14274E] mb-8">Learning Outcomes That Speak</h2>
        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-xl shadow-sm transform transition hover:scale-[1.02]">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-16 h-16 bg-[#14274E]/10 rounded-full flex items-center justify-center">
                <span className="text-2xl font-bold text-[#14274E]">N1</span>
              </div>
              <div>
                <div className="font-semibold text-[#14274E]">Akiko Thompson</div>
            ...
            <p className="text-[#14274E]/70">
              "From N3 to N1 in 14 months. ONIGIRI's advanced courses and Kouyou's teaching methods 
              were key to mastering complex grammar and business Japanese."
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm transform transition hover:scale-[1.02]">
            <div className="flex items-center gap-4 mb-3">
              <div className="w-16 h-16 bg-[#14274E]/10 rounded-full flex items-center justify-center">
                <span className="text-2xl font-bold text-[#14274E]">N2</span>
              </div>
              <div>
                <div className="font-semibold text-[#14274E]">David Chen</div>
                <div className="text-sm text-[#14274E]/70">
            ...
            <p className="text-[#14274E]/70">
              "The structured curriculum and JLPT-focused content helped me achieve N2 in just 10 months. 
              Now I'm confidently pursuing my degree in Tokyo!"
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md">
          ...
          <div className="space-y-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <p className="text-white/90">Expert-crafted curriculum by Kouyou Institute's senior instructors</p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-6 h-6 mt-1 text-green-400 flex-shrink-0" />
              <p className="text-white/90">Proven JLPT preparation system with 95% success rate</p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-6 h-6 mt-1 text-green-400 flex-shrink-0" />
              <p className="text-white/90">Personalized learning path from absolute beginner to N1</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/70 text-center mt-4">
              Join 50,000+ learners • No credit card required • Cancel anytime
            </p>
          </div>
        </div>
      </div>
  ...
  <div className="px-6 mx-auto max-w-7xl">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
      ...
      <div className="col-span-2 md:col-span-1">
        <div className="flex items-center gap-2 mb-6">
          <img src='src\Homepage\assets\ONIGIRIwhite.svg' alt="ONIGIRI Logo" className="w-8 h-8" />
          <span className="text-xl font-bold">ONIGIRI</span>
        </div>
        <p className="text-white/70 mb-4">
          Your journey to Japanese fluency starts here. Powered by Kouyou Institute's proven methodology.
        </p>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-white/70 hover:text-white">JLPT Prep</a></li>
          <li><a href="#" className="text-white/70 hover:text-white">Learning Paths</a></li>
          <li><a href="#" className="text-white/70 hover:text-white">Practice Tests</a></li>
          <li><a href="#" className="text-white/70 hover:text-white">Study Groups</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#" className="text-white/70 hover:text-white">Feedback</a></li>
        </ul>
      </div>
    </div>
    ...
    <div className="border-t border-white/10 pt-8 pb-12">
      <div className="max-w-md">
        ...
        <p className="text-white/70 mb-4">Get the latest updates on new courses and JLPT resources.</p>
    ...
    <div className="border-t border-white/10 pt-8">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 text-sm">
          ...
          <a href="#" className="text-white/50 hover:text-white">Cookie Policy</a>
        </div>
      </div>
    </div>
  </div>
